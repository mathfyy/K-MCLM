...
from K_MCLM.resnet2D import resnet101, cscBlock
if __name__ == '__main__':
    ...
    model_type = 'K_MCLM'
    data_path = '/data1/Data/GBM/BrainTumorGene/chestmnist/'
    ...
    for task_id in range(num_tasks):
        ...
        for i in range((int(task_id) + 1)):
            ...
            csc.load_state_dict(torch.load(model_path + '/csc_model' + str(task_id) + '.pt'), False)
