        ...
        for index, (image_ids, inputs, labels) in enumerate(train_loader):
            ...
            with torch.set_grad_enabled(True):
                ...
                pickle.dump({'class_token': class_token},
                            open(data_path + result_path + split_type + '/class_token' + str(task_id) + '.pkl', 'wb'),
                ...
                pickle.dump({'Ag_param': Ag_param},
                            open(data_path + result_path + split_type + '/Ag_param' + str(task_id) + '.pkl', 'wb'),
                            pickle.HIGHEST_PROTOCOL)
...
data_path = '/data/students/wyj/CL_gene_data/'
result_path='/result/emed_0.75_a_b/'
...
if __name__ == '__main__':
    ...
    for task_id in range(num_tasks):
        ...
        if (int(task_id) == 0):
            ...
            result = pickle.load(open(data_path + result_path + split_type + '/class_token' + str(int(task_id) - 1) + '.pkl', 'rb'))
            ...
            result = pickle.load(open(data_path + result_path + split_type + '/Ag_param' + str(int(task_id) - 1) + '.pkl', 'rb'))
        ...
        torch.save(CNN.state_dict(), data_path + result_path + split_type + '/CNN_model' + str(task_id) + '.pt')
        torch.save(csc.state_dict(), data_path + result_path + split_type + '/csc_model' + str(task_id) + '.pt')
